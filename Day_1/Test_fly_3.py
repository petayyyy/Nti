...
print navigate(x=0, y=3*0.9, z=1, speed=0.5, frame_id='aruco_map')
rospy.sleep(7)
...
for i in range (b):
    for j in range (n*2-4):
        if i % 2 == 0:
            print navigate(x=j*0.45 + x_start, y=i*0.9 + y_start, z=1, speed=0.25, frame_id='aruco_map')
        else:
            print navigate(x=(n-j)*0.45 + x_start, y=i*0.9 + y_start, z=1, speed=0.25, frame_id='aruco_map')
        rospy.sleep(2)
        print(j,i)
        print(i*0.9 + y_start)
